...
SELECT produits.* 
FROM produits J
JOIN commandes_produits ON produits.id = commandes_produits.produit_id 
WHERE commandes_produits.commande_id = 1; -- Remplacez 1 par l'ID de la commande souhaitée
